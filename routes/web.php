...
// Controller Bank Soal berbasis RBAC (Single Source of Truth)
use App\Http\Controllers\Admin\BankSoalAdminController;
use App\Http\Controllers\Guru\BankSoalGuruController;
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // ================================================================
    // BANK SOAL — Single Source of Truth (RBAC: Admin READ-only)
    // Prefix: /admin/v2/bank-soal  (terpisah dari rute lama di atas)
    // ================================================================
    Route::prefix('v2')->name('v2.')->group(function () {
        // Bank Soal — hanya READ untuk Admin
        Route::get('/bank-soal', [BankSoalAdminController::class, 'index'])->name('bank-soal.index');
        Route::get('/bank-soal/{bankSoal}', [BankSoalAdminController::class, 'show'])->name('bank-soal.show');

        // Ujian — CRUD penuh, Admin memilih bank_soal_id via dropdown
        Route::get('/ujian', [BankSoalAdminController::class, 'ujianIndex'])->name('ujian.index');
        Route::get('/ujian/create', [BankSoalAdminController::class, 'ujianCreate'])->name('ujian.create');
        Route::post('/ujian', [BankSoalAdminController::class, 'ujianStore'])->name('ujian.store');
        Route::get('/ujian/{ujian}', [BankSoalAdminController::class, 'ujianShow'])->name('ujian.show');
        Route::get('/ujian/{ujian}/edit', [BankSoalAdminController::class, 'ujianEdit'])->name('ujian.edit');
        Route::put('/ujian/{ujian}', [BankSoalAdminController::class, 'ujianUpdate'])->name('ujian.update');
        Route::delete('/ujian/{ujian}', [BankSoalAdminController::class, 'ujianDestroy'])->name('ujian.destroy');
    });
...
Route::middleware(['auth', 'role:guru'])->prefix('guru')->name('guru.')->group(function () {
    ...
    // Analytics Dashboard
    Route::get('/analytics', [GuruController::class, 'analyticsDetail'])->name('analytics');
    ...
    Route::get('/get-students-by-class/{classId}', [GuruController::class, 'getStudentsByClass'])->name('get-students-by-class');
    ...
    // ================================================================
    // BANK SOAL — Single Source of Truth (RBAC: Guru CRUD, scoped ke guru_id)
    // Prefix: /guru/v2/bank-soal  (terpisah dari rute lama di atas)
    // ================================================================
    Route::prefix('v2')->name('v2.')->group(function () {
        // Bank Soal — CRUD penuh, data di-scope hanya milik guru ini
        Route::get('/bank-soal', [BankSoalGuruController::class, 'index'])->name('bank-soal.index');
        Route::get('/bank-soal/create', [BankSoalGuruController::class, 'create'])->name('bank-soal.create');
        Route::post('/bank-soal', [BankSoalGuruController::class, 'store'])->name('bank-soal.store');
        Route::get('/bank-soal/{bankSoal}', [BankSoalGuruController::class, 'show'])->name('bank-soal.show');
        Route::get('/bank-soal/{bankSoal}/edit', [BankSoalGuruController::class, 'edit'])->name('bank-soal.edit');
        Route::put('/bank-soal/{bankSoal}', [BankSoalGuruController::class, 'update'])->name('bank-soal.update');
        Route::delete('/bank-soal/{bankSoal}', [BankSoalGuruController::class, 'destroy'])->name('bank-soal.destroy');

        // Soal — CRUD butir soal di dalam bank soal
        Route::get('/bank-soal/{bankSoal}/soal/create', [BankSoalGuruController::class, 'createSoal'])->name('soal.create');
        Route::post('/bank-soal/{bankSoal}/soal', [BankSoalGuruController::class, 'storeSoal'])->name('soal.store');
        Route::get('/bank-soal/{bankSoal}/soal/{soal}/edit', [BankSoalGuruController::class, 'editSoal'])->name('soal.edit');
        Route::put('/bank-soal/{bankSoal}/soal/{soal}', [BankSoalGuruController::class, 'updateSoal'])->name('soal.update');
        Route::delete('/bank-soal/{bankSoal}/soal/{soal}', [BankSoalGuruController::class, 'destroySoal'])->name('soal.destroy');

        // Upload gambar untuk Rich Text Editor (editor pembuat soal) — Guru
        // Endpoint : POST /guru/v2/upload-image
        // Field    : 'file' (image, max 20MB)
        // Response : JSON { success, file: { name, url }, link }
        Route::post('/upload-image', [GuruController::class, 'uploadSoalImage'])->name('upload-image');
    });
    ...
    Route::patch('/nilai-ujian/{resultId}/update-score', [GuruController::class, 'updateExamScore'])->name('nilai-ujian.update-score');
