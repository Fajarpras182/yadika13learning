...
class User extends Authenticatable
{
    ...
    // Relasi untuk siswa (otomatis dari class_id)
    ...
    /**
     * Bank soal yang dimiliki oleh guru ini.
     * Hanya relevan untuk user dengan role 'guru'.
     */
    public function bankSoals()
    {
        return $this->hasMany(BankSoal::class, 'guru_id');
    }
