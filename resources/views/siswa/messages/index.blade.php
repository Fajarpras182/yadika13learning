...
@section('title', 'Forum & Pesan - Siswa')
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card shadow border-0">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('siswa.messages.send') }}" id="mainMessageForm">
                    @csrf
                    <div class="mb-3">
...
<div class="modal fade" id="replyModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content border-0 shadow">
            <form method="POST" action="{{ route('siswa.messages.send') }}">
                @csrf
