                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="card sesi-card h-100" data-start="{{ $start?->timestamp ?? 0 }}" data-end="{{ $end?->timestamp ?? 0 }}" data-completed="{{ $completed ? '1' : '0' }}" data-action-url="{{ route('siswa.ujian.mulai', $session) }}">
                            ...
                            <div class="card-body py-3">
                                ...
                                @if($completed && $session->ujian->tampilkan_hasil)
                                    <a href="{{ route('siswa.ujian.result-pdf', $result->id) }}" class="btn btn-sm btn-outline-primary w-100 mb-2">
                                        <i class="fas fa-file-pdf me-1"></i> Download Hasil (PDF)
                                    </a>
                                @endif
