...
@section('title', 'Detail Ujian - Guru')
...
<div class="card shadow">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('guru.ujian') }}" class="btn btn-secondary btn-sm">
    ...
    <div class="card-footer d-flex justify-content-between align-items-center">
        <div>
            <strong>Soal:</strong> {{ $ujian->bank_questions_count }} tersedia
            @if($ujian->bank_questions_count == 0)
                <br><small class="text-muted">Tambah soal lewat <strong>Kelola bank soal</strong> (tambah manual atau impor file).</small>
            @endif
        </div>
        <div>
            <a href="{{ route('guru.bank-soal', ['ujian_id' => $ujian->id, 'course_id' => $ujian->course_id]) }}" class="btn btn-success">
