...
<div class="card shadow">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('guru.ujian.show', $ujian->id) }}" class="btn btn-secondary btn-sm">
                ...
                <div class="card border-success">
                    ...
                    <div class="card-body" style="max-height: 400px; overflow-y: auto;">
                        @if($availableQuestions->count() > 0)
                            <form id="addQuestionsForm" method="POST" action="{{ route('guru.ujian.store-questions', $ujian->id) }}">
                                @csrf
                                <div class="mb-3">
                        ...
                        @else
                            <div class="text-center py-3">
                                ...
                                <a href="{{ route('guru.bank-soal.create') }}" class="btn btn-primary btn-sm">
...
function removeQuestion(questionId, questionText) {
    ...
    if (confirm('Yakin ingin menghapus soal ini dari ujian?\n\n"' + truncatedText + '"\n\nSoal akan dikembalikan ke bank soal.')) {
        ...
        form.method = 'POST';
        form.action = `/guru/ujian/{{ $ujian->id }}/remove-question/${questionId}`;
