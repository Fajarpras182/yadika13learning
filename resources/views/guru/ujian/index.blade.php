...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="btn-group">
        <a href="{{ route('guru.ujian.create') }}" class="btn btn-primary" title="Buat ujian baru">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <span class="badge bg-info fs-6">{{ $exam->bank_questions_count ?? 0 }}</span>
                        </td>
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('guru.ujian.show', $exam->id) }}">
                                            <i class="fas fa-info-circle me-2 text-primary"></i>Detail Ujian
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{ route('guru.bank-soal', ['ujian_id' => $exam->id, 'course_id' => $exam->course_id]) }}">
                                            <i class="fas fa-database me-2 text-success"></i>Kelola bank soal
                                        </a>
                                    </li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li>
                                        <a class="dropdown-item" href="{{ route('guru.ujian.edit', $exam->id) }}">
...
<div class="text-center py-5">
    ...
    <a href="{{ route('guru.ujian.create') }}" class="btn btn-primary btn-lg">
