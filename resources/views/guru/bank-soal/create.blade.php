...
<div class="card shadow">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('guru.bank-soal', array_filter(['ujian_id' => request('ujian_id'), 'course_id' => request('course_id')], fn ($v) => $v !== null && $v !== '')) }}" class="btn btn-secondary btn-sm">
    ...
    <div class="card-body">
        ...
        <form id="soalForm" method="POST" action="{{ route('guru.bank-soal.store') }}">
            @csrf
                ...
                <select class="form-select @error('course_id') is-invalid @enderror"
                    ...
                    @foreach($courses as $course)
                        <option value="{{ $course->id }}" {{ old('course_id') == $course->id ? 'selected' : '' }}>
                            {{ $course->nama_mata_pelajaran }}@if($course->schoolClass) — {{ $course->schoolClass->name }}@endif
                        </option>
                    @endforeach
                </select>
                @error('course_id')
...
$(document).ready(function() {
    ...
    editorFields.forEach(function(field) {
        ...
        const existingContent = $('#' + field + '_input').val();
        if (existingContent) {
            $('#' + field).summernote('code', existingContent);
        }
    });
