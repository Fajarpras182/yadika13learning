                            ...
                            <tr>
                                ...
                                <td>
                                    @if($grade->file_jawaban)
                                        <a href="{{ asset('storage/'.$grade->file_jawaban) }}" target="_blank" class="btn btn-sm btn-outline-secondary">
                                ...
                                <td style="width: 120px">
                                    <input type="number" name="nilai[{{ $grade->id }}]" min="0" max="{{ $assignment->bobot_nilai }}" value="{{ old('nilai.'.$grade->id, $grade->nilai) }}" class="form-control form-control-sm" placeholder="0-{{ $assignment->bobot_nilai }}">
                                </td>
                                <td>
