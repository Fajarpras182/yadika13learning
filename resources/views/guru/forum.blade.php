...
@section('title', 'Forum Diskusi - Guru')
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-start">
                                            ...
                                            <div class="d-flex align-items-center">
                                                @if($message->sender_id != auth()->id() && !$message->is_read)
                                                    <form action="{{ route('guru.messages.read', $message->id) }}" method="POST" class="d-inline me-2">
                                                        @csrf
                                                        @method('PATCH')
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item" href="{{ route('guru.messages.edit', $message->id) }}">Edit</a></li>
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <div class="d-flex justify-content-between align-items-start">
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li><a class="dropdown-item" href="{{ route('guru.messages.edit', $reply->id) }}">Edit</a></li>
...
<div class="modal fade" id="newMessageModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('guru.messages.send') }}" method="POST">
                @csrf
...
function deleteMessage(messageId) {
    if (confirm('Apakah Anda yakin ingin menghapus pesan ini?')) {
        ...
        form.method = 'POST';
        form.action = `/guru/messages/${messageId}`;
