...
@section('title', 'Edit Ujian - Admin')
...
<div class="card shadow">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('admin.ujian.update', $ujian->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="d-flex gap-2 align-items-center">
                ...
                <a href="{{ route('admin.ujian') }}" class="btn btn-secondary">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form method="POST" action="{{ route('admin.ujian.delete', $ujian->id) }}" style="display: inline;">
                    @csrf
                    @method('DELETE')
