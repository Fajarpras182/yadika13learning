...
@section('title', 'Buat Ujian Baru - Admin')
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="{{ route('admin.ujian') }}" class="btn btn-outline-secondary btn-sm">
...
<div class="card shadow-sm">
    <div class="card-body">
        <form id="form-buat-ujian" method="POST" action="{{ route('admin.ujian.store') }}">
            @csrf
