...
@section('title', 'Edit Sesi Ujian - Admin')
    ...
    <div class="col-md-8">
        <div class="card shadow-sm">
            <div class="card-header bg-warning text-dark">
                <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Sesi Ujian</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.sesi-ujian.update', $sesi->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" name="waktu_mulai" id="waktu_mulai" class="form-control @error('waktu_mulai') is-invalid @enderror" value="{{ old('waktu_mulai', $sesi->waktu_mulai?->timezone('Asia/Jakarta')->format('Y-m-d\TH:i')) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" name="waktu_selesai" id="waktu_selesai" class="form-control @error('waktu_selesai') is-invalid @enderror" value="{{ old('waktu_selesai', $sesi->waktu_selesai?->timezone('Asia/Jakarta')->format('Y-m-d\TH:i')) }}" required>
                                <small class="text-muted">Format: Tanggal dan jam dalam zona waktu Jakarta (WIB)</small>
                                @error('waktu_selesai')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
