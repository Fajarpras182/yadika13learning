...
- ✅ Export/Import data Excel (termasuk format lain seperti CSV/PDF/Word jika tersedia)

#### ✅ Mata Pelajaran & Fitur Guru (Guru)
- ✅ Dashboard Guru
- ✅ Mata Pelajaran yang diajar (akses cepat per course)
- ✅ Kelola **Materi**
- ✅ Kelola **Tugas** (buat tugas, edit, nilai, hapus)
- ✅ Kelola **Ujian** (UTS/UAS/Kuis/Remedial) + pengaturan durasi/bobot
- ✅ Kelola **Absensi** (input status hadir/izin/sakit/alpa per tanggal)

#### ✅ Kumpulkan & Nilai (Siswa)
- ✅ Lihat daftar **Tugas** dan kumpulkan jawaban (upload file atau tulis teks)
- ✅ Lihat **Nilai** beserta feedback (jika sudah dinilai)
- ✅ Profil Siswa (update data)

#### ⭐ Nilai Ujian (Fitur Terbaru)
- ✅ Filter hasil ujian berdasarkan **kelas**
- ✅ Review jawaban siswa per ujian (modal/detail per soal)
- ✅ Statistik skor: jumlah benar/salah/total
- ✅ Tampilan badge persentase (kategori skor)
- ✅ Export nilai ke **CSV** untuk dibuka di Excel
  - Nama file: `nilai-ujian-YYYYMMDD-HHmmss.csv`
  - Delimiter `;` dan UTF-8 BOM agar kompatibel dengan Excel
